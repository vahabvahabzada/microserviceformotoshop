...
public class SellerOperations extends CustomerOperations{
    private final UserRepo userRepo;
    private final PhotoRepo photoRepo;
    private final CarMapper carMapper;
    private final CarRepo carRepo;
    private final RestTemplate restTemplate;
    public SellerOperations(CarRepo carRepo,CarMapper carMapper,UserRepo userRepo,PhotoRepo photoRepo,RestTemplate restTemplate){
